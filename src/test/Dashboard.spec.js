...
//    expect(shallow(<Dashboard /> ).length ).to.eql(1);
//  });
...
//  it('modal popup is open', function(){
//     const wrapper = shallow(<Dashboard/>);
//      wrapper.setState({ showModal : true });
//  })

//   describe('fill all the fields of create post modal popup', function(){
...
//    it('modal popup is closed', function(){
//      const wrapper = shallow(<Dashboard/>);
